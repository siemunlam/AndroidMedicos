...
public class FinalizarAuxilioActivity extends ToolbarActivity implements ChangeVisibilityButtonListener {
    ...
    public void showButton() {
        if(mBinding.sendButton.getVisibility() != View.VISIBLE){
            mBinding.sendButton.startAnimation(AnimationUtils.loadAnimation(FinalizarAuxilioActivity.this, R.anim.show_button));
    ...
    public void hideButton(){
        if(mBinding.sendButton.getVisibility() != View.GONE){
            mBinding.sendButton.startAnimation(AnimationUtils.loadAnimation(FinalizarAuxilioActivity.this, R.anim.hide_button));
